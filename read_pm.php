                ...
                if (isset($_POST['message']) and $_POST['message'] != '') {
                    ...
                    <div class="content">
                        ...
                        if (isset($_SESSION['username'])) {
                            ...
                            <div class="box">
                                <div class="box_left">
                                    <a href="<?php echo $url_home; ?>">Forum Index</a> &gt; <a href="list_pm.php">List
                                        of your PMs</a> &gt; Read a PM
                                </div>
                                <div class="box_right">
                            ...
                            while ($dn2 = mysql_fetch_array($req2)) {
                                ...
                                <tr>
                                    <td class="author center"><?php
                                        ...
                                        ?><br/><a
                                            href="profile.php?id=<?php echo $dn2['userid']; ?>"><?php echo $dn2['username']; ?></a>
                                    </td>
                                    <td class="left">
                                        <div class="date">Date sent: <?php echo date('Y/m/d H:i:s',
                                                $dn2['timestamp']); ?></div>
