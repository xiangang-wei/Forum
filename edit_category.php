    ...
    if ($dn1['nb1'] > 0) {
        if (isset($_SESSION['username']) and $_SESSION['username'] == $admin) {
            ...
            <div class="content">
                ...
                <div class="box">
                    <div class="box_left">
                        <a href="<?php echo $url_home; ?>">Forum Index</a> &gt; <?php echo htmlentities($dn1['name'],
                            ENT_QUOTES, 'UTF-8'); ?> &gt; Edit the category
                    </div>
                    <div class="box_right">
